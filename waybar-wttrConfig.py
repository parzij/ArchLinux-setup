...
weather = requests.get("https://wttr.in/taganrog?format=j1").json()
...
icon = WEATHER_CODES[weather['current_condition'][0]['weatherCode']].strip()

data['text'] = f"{icon} {extrachar}{weather['current_condition'][0]['FeelsLikeC']}°C"
